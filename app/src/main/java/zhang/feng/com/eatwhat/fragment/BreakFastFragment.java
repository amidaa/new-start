...
public class BreakFastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FoodAdapter foodAdapter = new FoodAdapter(R.layout.item_foodlist,mFoods);
    ...
    public class FoodAdapter extends BaseQuickAdapter<Food, BaseViewHolder>{
        ...
        public FoodAdapter(@LayoutRes int layoutResId,@Nullable List<Food> foods){
