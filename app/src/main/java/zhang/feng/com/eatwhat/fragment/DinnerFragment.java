...
public class DinnerFragment extends Fragment {
    ...
    public class DinnerAdapter extends BaseQuickAdapter<Food, BaseViewHolder> {

        public DinnerAdapter(@LayoutRes int layoutResId, @Nullable List<Food> foods){
    ...
    private void preparDate(){
        ...
        for(int i=0;i<5;i++){
            Food food = new Food();
            food.setFoodName("luobo"+i);
            food.setFondWeight("1kg");
            mDinnerFood.add(food);
        }
