...
public class LunchFragment extends Fragment {
    ...
    public class LunchAdapter extends BaseQuickAdapter<Food, BaseViewHolder> {

        public LunchAdapter(@LayoutRes int layoutResId, @Nullable List<Food> foods){
