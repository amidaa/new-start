...
public class EnergyChart extends AppCompatActivity {
    ...
    private int[] colorData = {Color.parseColor("#ec063d"),
            ...
            Color.parseColor("#ccc63d")};
    private String[] statechart = {"脂肪", "碳水化合物", "蛋白质", "维生素", "氨基酸"};
    ...
    private PieChartOnValueSelectListener selectListener = new PieChartOnValueSelectListener() {
        ...
        public void onValueSelected(int arcIndex, SliceValue value) {
            //选择对应图形后，在中间部分显示相应信息
            pie_data.setCenterText1(statechart[arcIndex]);
